...
for name in ["app.py", "tmu_parser.py", "tmu_parser_compat.py", "tmu_parser_legacy.py", "smart_tabular_v75.py", "history_analysis.py"]:
    py_compile.compile(str(ROOT / name), doraise=True)

assert 'APP_UI_BUILD_ID = "v97-portable-pdf-v92-events-20260702"' in APP_TEXT
